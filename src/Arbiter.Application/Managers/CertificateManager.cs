...
public class CertificateManager : ICertificateManager
{
    ...
    public void Set(string hostName, X509Certificate2 certificate) => _certificates[hostName] = certificate;

    public X509Certificate2? Get(string hostName) => _certificates.GetValueOrDefault(hostName);

    public X509Certificate2 GetFallback() => _fallbackCertificate;
