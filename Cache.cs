...
namespace Arbiter {
    public class Cache {
        ...
        private ConcurrentDictionary<string, ObjectEntry> _ties = new ConcurrentDictionary<string, ObjectEntry>();
        private ConcurrentDictionary<string, ObjectEntry> _objects = new ConcurrentDictionary<string, ObjectEntry>();
        private ConcurrentDictionary<string, SegmentHandle> _segments = new ConcurrentDictionary<string, SegmentHandle>();
        private Thread _striker;
